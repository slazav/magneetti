...
plot\
 ...
 "sol2.fit" using 1:3 with lines lc 0 title "gradient fit"
pause -1

#set output "pl_c.fig"
plot\
 "sol3.fld" using 1:3 with lines title "calculated data - quad",\
 "sol3.fit" using 1:4 with lines lc 0 title "quadratic fit, r=0",\
 "sol3.fit" using 1:5 with lines lc 3 title "quadratic fit, r=r0"
pause -1